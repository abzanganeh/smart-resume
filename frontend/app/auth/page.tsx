    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl">
          ...
          {successMsg && (
            <div className="mb-5 p-3 rounded-lg bg-emerald-950/60 border border-emerald-800 text-emerald-300 text-sm">
              {successMsg}
            </div>
          )}
              ...
              {!showRecovery ? (
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-800 border border-slate-700 rounded-lg px-4 py-2.5 text-white text-center text-xl tracking-widest placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-amber-400/50"
                    autoFocus
                  />
                </div>
              ) : (
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-800 border border-slate-700 rounded-lg px-4 py-2.5 text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-amber-400/50"
                    autoFocus
                  />
                </div>
              )}
              ...
              >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-slate-800 border border-slate-700 rounded-lg pl-10 pr-4 py-2.5 text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-amber-400/50"
                      />
                    </div>
                  </div>
                )}
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-300 mb-1.5">
                    Password
                    {view === "register" && (
                      <span className="text-slate-500 font-normal ml-1">(min 10 chars)</span>
                    )}
                  </label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-800 border border-slate-700 rounded-lg pl-10 pr-10 py-2.5 text-white placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-amber-400/50"
                    />
                    <button
                      type="button"
                  ...
                  <div className="space-y-3 pt-1">
                    <label className="flex items-start gap-2.5 cursor-pointer">
                      ...
                      <span className="text-sm text-slate-400">
                        I agree to the{" "}
                        <a href="/legal/terms" target="_blank" className="text-amber-400 hover:underline">
                          Terms of Service
                        </a>{" "}
                    ...
                    <label className="flex items-start gap-2.5 cursor-pointer">
                      ...
                      <span className="text-sm text-slate-400">
                        I have read the{" "}
                        <a href="/legal/privacy" target="_blank" className="text-amber-400 hover:underline">
                          Privacy Policy
                        </a>{" "}
                        <span className="text-red-400">*</span>
                      </span>
        ...
        <p className="text-center text-slate-600 text-xs mt-6">
          By using Smart Resume you agree to our{" "}
          <a href="/legal/terms" className="hover:text-slate-400 underline underline-offset-2">
            Terms
          </a>{" "}
          and{" "}
          <a href="/legal/privacy" className="hover:text-slate-400 underline underline-offset-2">
            Privacy Policy
          </a>
          .
        </p>
