...
export function HeroMessageRotator({
  ...
  const taglineClass = viewport
    ? "hero-message-set__tagline text-base sm:text-lg text-slate-700 dark:text-slate-300 max-w-2xl mx-auto font-medium leading-snug"
  ...
  const bodyClass = viewport
    ? "hero-message-set__body text-sm sm:text-base text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed"
