"""TierStepLLMConfig — admin-tunable provider/model pin per plan_code × pipeline step."""
...
class TierStepLLMConfig(Base):
    __tablename__ = "tier_step_llm_configs"
    ...
    __table_args__ = (
        Index("ix_tier_step_llm_configs_plan_step_active", "plan_code", "step", "is_active"),
        Index(
            "uq_tier_step_llm_configs_one_active_per_plan_step",
            "plan_code",
            "step",
            unique=True,
