"""Integration tests for DB-first job search (slice 7)."""
...
async def _register(client: AsyncClient) -> tuple[str, str]:
    email = f"dbfirst-{uuid.uuid4().hex[:8]}@example.com"
...
@pytest.mark.asyncio
async def test_db_first_search_returns_corpus_without_hirebase(
